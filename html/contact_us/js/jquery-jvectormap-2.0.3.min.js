        ...
        "undefined" != typeof anchorX &&
          ...
          isCentered
            ? ((transX =
                anchorX +
                (this.defaultWidth *
                  (this.width * 0.6 / (this.defaultWidth * scale))) /
                  2),
              (transY =
                anchorY +
                (this.defaultHeight *
    ...
    setFocus: function (config) {
      ...
      if (
        ...
        return this.setScale(
          Math.min(this.width / (bbox.width * 5), this.height / (bbox.height * 5)),
          -(bbox.x + bbox.width / 2),
  ...
  (jvm.MultiMap.prototype = {
    ...
    goBack: function () {
      var currentMap = this.history.pop(),
        ...
        that = this;
      currentMap
        .setFocus({ scale: 1.5, x: 0.5, y: 0.5, animate: !0 })
        .then(function () {
          currentMap.params.container.hide(),
            prevMap.params.container.show(),
            prevMap.updateSize(),
            1 === that.history.length && that.backButton.hide(),
            prevMap.setFocus({ scale: 1.5, x: 0.5, y: 0.5, animate: !0 });
        });
    },
  }),
